    ...
    <section className="bg-black py-12 px-6 md:px-16 flex flex-col items-center justify-center gap-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center items-center">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 sm:px-8 py-3 bg-amber-500 hover:bg-amber-600 text-black font-semibold text-base rounded-full shadow-lg transition-colors duration-300 touch-manipulation"
        >
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.98 }}
          transition={{ type: "spring", stiffness: 300, damping: 20 }}
          className="w-full sm:w-auto px-6 sm:px-8 py-3 border border-zinc-700 bg-zinc-900/50 hover:bg-amber-500 hover:text-black text-white font-extrabold rounded-full backdrop-blur-sm transition-colors duration-300 text-center text-2xl touch-manipulation"
        >
